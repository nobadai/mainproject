...
BEGIN
    SELECT remaining_qty_kg, status
     ...
     WHERE lot_id = 'LOT-KIMCHI-015-GEONGOCHU'
       AND sim_run_id = 'SIM-BURNIN-202512'
     FOR UPDATE;

    IF NOT FOUND THEN
        RAISE EXCEPTION 'MVP demo dried-pepper lot was not found';
    END IF;
    ...
    IF target_remaining <> 12.120000 OR target_status <> 'ACTIVE' THEN
        RAISE EXCEPTION
            'Unexpected dried-pepper lot state: remaining=%, status=%',
            target_remaining,
            target_status;
    END IF;
    ...
    INSERT INTO haetdeul.inventory_moves (
        ...
        'MOVE-MVP-FIX-GEONGOCHU-DAY30',
        'SIM-BURNIN-202512',
        'LOT-KIMCHI-015-GEONGOCHU',
        NULL,
        'DISPOSE',
        12.120000,
        DATE '2025-12-31',
        'MVP_DEMO_FIXTURE_CORRECTION',
        'Remove dried red pepper from the current AGENT_MVP_DEMO inventory fixture.'
    )
