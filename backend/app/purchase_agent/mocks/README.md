...
## 실측 밴드 — 이 mock 은 실제보다 **9~12배 좁다** (2026-09-10)

ML(지환님) 회신 §6 이 지적했고, **우리가 실제로 그 함정을 밟았다.**
...
⚠️ `ci_width` 열은 **LT별 중앙값의 범위**다 (LT1~LT18). 한 줄 단위로는 더 넓게 흩어진다 —
배추 개별 최대는 1.805다.
