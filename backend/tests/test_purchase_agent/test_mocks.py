...
def test_moving_one_item_leaves_the_others_where_they_were(
    ...
    🔴 **순서를 잘못 옮겨 적었다** (2026-09-06 정정). 여기 *"#67 이 확정한 순서가
      양파 < 무 < 배추"* 라고 적혀 있었는데, 그건 그 표의 **"깨지는 비율"** 순서다.
      **임계 순서는 양파 0.1032 < 배추 0.1048 < 무 0.1078 로 무·배추가 뒤바뀐다.**
      표는 ``constraints.yaml`` §situation 주석에 있다.
